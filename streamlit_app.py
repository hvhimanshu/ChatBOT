...
def main():
    ...
    if user_input:
        ...
        pneumonia_symptoms = ["fever", "chills", "cough", "shortness of breath", "chest pain", "fatigue"]
        unrelated_symptoms = ["headache", "stomach pain", "leg pain", "hand pain", "neck pain", "eye strain", "strain in eye", "back pain"]

        lower_input = user_input.lower()
        matched_pneumonia = any(symptom in lower_input for symptom in pneumonia_symptoms)
        matched_unrelated = any(symptom in lower_input for symptom in unrelated_symptoms)
